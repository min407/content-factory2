...
export async function generateSingleArticle(params: CreationParams): Promise<GeneratedArticle> {
  ...
  if (creationMode === 'reference' && referenceArticles.length > 0) {
    ...
    referenceContent = `
**【核心任务】将以下对标文章改写成"卷儿"的版本，保持原文核心内容和结构，但要融入卷儿的人设和经历！**
...
**第二步：卷儿化改写**
- 将原文的"我朋友"、"某用户"、"别人案例"替换为"卷儿我"的真实经历
- 将原文的说教式、专家式语言改为卷儿的"陪伴式、拆解式"语言
- 保持原文的观点和结论，但用卷儿的思考过程和表达方式重新组织

**第三步：语言风格转换**
- 原文："你应该..." → 卷儿版："我发现，当...的时候，更容易..."
- 原文："大家都要..." → 卷儿版："我们很多女生都会遇到..."
- 原文："专家建议..." → 卷儿版："我自己的经验是..."
- 保持口语化的"跟姐妹聊天"的感觉

**第四步：经历替换与融合**
- 用卷儿的真实经历替换原文中的案例
- 保持案例要说明的观点不变，但换成卷儿的故事
- 每个经历后要有"卷儿式"的思考和拆解
...
**【示例改写】**
- 原文："我有个朋友小A，去年转行做大数据，现在月薪3万"
- 卷儿版："说起来，卷儿我在2019年转行的时候，那时候真的很苦..."
- 原文："职场新人要学会3个技能"
- 卷儿版："我发现很多职场女生都会焦虑技能问题，我自己的经历是..."
`
...
${creationMode === 'reference' ? `
**【对标创作核心要求】**：
1. **改写而非原创**：基于对标文章内容进行卷儿化改写，保持原文核心观点和结构
2. **结构完全保持**：必须保持与对标文章完全相同的结构类型和段落安排
3. **语言风格转换**：将原文的语言风格转换为卷儿的"陪伴式、拆解式"语言
4. **经历自然替换**：用卷儿的真实经历替换原文中的案例，保持观点不变

**【卷儿化改写规则】**：
- 原文："你应该..." → 卷儿版："我发现，当...的时候，更容易..."
- 原文："我朋友小A..." → 卷儿版："说起来，卷儿我..."
- 原文："专家建议..." → 卷儿版："我自己的经验是..."
- 保持口语化的"跟姐妹聊天"的感觉
