...
**第一步：开头方式对标分析**
- 分析对标文章如何开头：是"我跟朋友聊天"模式？还是"大家好，我是XX"模式？
- 记录具体的开头句式、称呼方式、话题引入方式
- 模仿同样的开头风格和语气

**第二步：文章结构对标分析**
- 识别对标文章的结构类型：是故事体？清单体？干货体？还是混合结构？
- 分析段落安排：每段大概多少字？如何过渡？
- 记录小标题使用方式、分段技巧

**第三步：表达方式对标分析**
- 分析语言风格：口语化程度、用词习惯、句式特点
- 记录人称使用：第一人称"我"？第二人称"你"？还是第三人称？
- 分析情感表达方式：如何引发共鸣？如何营造氛围？

**第四步：结尾方式对标分析**
- 分析对标文章如何结尾：是总结观点？引发思考？还是制造争议？
- 记录结尾的句式特点和情感倾向

**【二创创作指令】**
1. **开头**：必须模仿对标文章的开头方式，如果是"跟朋友聊天"就用同样模式
2. **结构**：必须采用与对标文章相同的结构类型，保持同样的段落节奏
3. **语言**：必须使用相似的语言风格和表达习惯
4. **结尾**：必须采用相似的结尾方式，同样的情感调性

**【个人经历融入规则】**
- 在保持对标结构的基础上，将我的个人经历自然替换或融入原文案例
- 如果对标文章用"我朋友小A"，你就用"我自己的经历"
- 保持原文的逻辑框架，但用我的真实经历填充内容
- 观点要与原文保持一致方向，但用我的语言重新表达

**【严禁事项】**
- 严禁完全原创，必须保持和对标文章的高度相似性
- 严禁改变文章的基本结构和表达方式
- 严禁使用与对标文章不同的开头结尾模式
- 严禁创造全新的观点，必须在对标文章观点基础上二创
`
...
`
  ...
  const getPersonalExperienceSnippet = (topicTitle: string, topicDesc: string): string => {
    // 个人经历素材库 - 专门用于替换对标文章中的案例
    const personalExperiences = [
      {
        keywords: ['转行', '重新开始', '改变', '职业', '工作', '选择', '人生', '成长'],
        snippet: `我记得2019年转行那会儿，真的是白天在培训班从早上九点学到晚上十点，回去还得继续敲代码，周末也不休息。最难的不是技术本身，是心里那种恐惧——我不是科班出身，简历都要包装，面试前紧张得手心冒汗。但现在回头看，那段虽然很苦但很充实。`,
        theme: '转行成长'
      },
      {
        keywords: ['独立', '依靠', '安全感', '靠自己', '责任', '承担', '家庭'],
        snippet: `作为家里老大，我从小就明白一个道理：凡事得靠自己。小时候要照顾弟弟妹妹，现在遇到事了第一反应也是怎么解决，而不是抱怨。这种习惯让我现在面对困难时，脑子里想的不是"怎么办"，而是"怎么搞定"。`,
        theme: '独立担当'
      },
      {
        keywords: ['深圳', '大城市', '闯荡', '梦想', '现实', '迷茫', '坚持'],
        snippet: `说起来惭愧，2017年来深圳的时候，我就一个行李箱，身上也没多少钱。那两年换了好多工作，最长的一份也就做了半年。那时候心里总有个声音在说："这样不对劲"。正是这种感觉，推着我去找真正想要的生活。`,
        theme: '城市闯荡'
      },
      {
        keywords: ['副业', '创业', '试错', '失败', '学习', '探索', '项目'],
        snippet: `去年做副业那会儿真是踩了不少坑：做虚拟资料遇到恶意差评，搞B站好物几天就放弃了。说实话，挺消耗人的。但每次失败都让我更明白一个道理：没价值感的事情，再赚钱也别做。这种"筛选"思维让我现在做选择谨慎多了。`,
        theme: '副业探索'
      },
      {
        keywords: ['运动', '健康', '改变', '坚持', '自律', '身体', '习惯'],
        snippet: `2023年那会儿我下定决心改变自己，每天下班后就去健身房跑步撸铁，周末就去爬山。半年下来瘦了二十多斤，还把多年的眼镜给摘了。最开心的不是身材变好了，而是那种"我能掌控生活"的感觉。`,
        theme: '身体管理'
      },
      {
        keywords: ['财务', '存钱', '记账', '债务', '理财', '规划', '消费'],
        snippet: `最困难的时候，我把每笔账都记得特别细，精确到几毛钱，就是为了算着什么时候能还清债务。现在想想，那种抠门不是小气，是对生活的尊重。虽然现在条件好点了，但清楚自己在哪里，这种感觉让我踏实。`,
        theme: '财务自律'
      },
      {
        keywords: ['关系', '分手', '感情', '沟通', '相处', '人际', '孤独'],
        snippet: `之前那段关系最后是以报警分手收场的，发现对方有跟踪这些问题。说实话挺痛的，但也让我明白：有些人、有些事，再舍不得也要及时止损。现在的我把安全感放在自己身上，专注过好自己的日子。`,
        theme: '关系边界'
      },
      {
        keywords: ['学习', '技能', '提升', '编程', 'AI', '技术', '进步'],
        snippet: `学编程那阵子经常加班到深夜，回到出租屋累得什么都不想干，但还是得硬着头皮啃文档、查资料。没人教就自己琢磨，现在想想，正是那段没人管的日子，让我学会了独立解决问题。`,
        theme: '学习成长'
      }
    ]
...
- 标题：**对标模式下直接使用原文章标题，无需生成新标题**

**【对标创作要求】**：
1. **结构对标**：必须保持与对标文章完全相同的结构类型
2. **开头对标**：必须模仿对标文章的开头方式（聊天式、自我介绍式等）
3. **结尾对标**：必须采用相似的结尾风格（总结式、争议式、思考式等）
4. **语言对标**：必须使用相似的语言风格和口语化程度

**【个人经历融入规则】**：
- 当对标文章使用"我朋友小A"、"我同事"、"我认识的人"等案例时，直接替换为我的个人经历
- 当对标文章使用某个观点或道理时，用我的个人经历来佐证这个观点
- 保持原文的逻辑框架和论述顺序，只替换案例和部分表达
- 用我自己的语言重新表达相同的观点，保持口语化、亲切感

**【示例】**：
- 原文："我有个朋友小A，去年转行做大数据..."
- 改写："我记得2019年转行那会儿，真的是白天在培训班..."
- 原文："现在年轻人都很焦虑..."
- 改写："说起来惭愧，现在我身边很多朋友也都在焦虑..."
...
`
  ...
  const articleContent = await callOpenAI([
    {
      role: 'system',
      content: `你是专业的内容二创专家，专门擅长对标分析和高模仿度创作。

**核心能力**：
1. **深度分析**：能够快速分析对标文章的结构、开头结尾方式、语言风格、表达习惯
2. **精准模仿**：能够高度还原对标文章的写作技巧和风格特点
3. **自然融合**：能够将个人经历自然替换到对标文章的框架中，保持原有逻辑
4. **口语化表达**：擅长用亲切自然的语言，像朋友聊天一样写作

**创作原则**：
- 严禁原创，必须基于对标文章进行二创
- 保持和对标文章80%以上的相似度（结构、风格、逻辑）
- 个人经历只是替换原文案例，不改变文章框架
- 重点关注开头、结尾、段落过渡这些关键技巧`
    },
